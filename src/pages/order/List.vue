<template>
  <div>
    <!-- 按钮 -->
    <el-button type="success" size="small" @click="toAddHandler">订单管理</el-button> 
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="primary" @click="submitHandler">保 存</el-button>
      </span>
    </el-dialog>
    <!-- /模态框 -->
